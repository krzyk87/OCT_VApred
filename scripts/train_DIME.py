"""
Training script for OCT image analysis with clinical data integration on DIME Dataset.
...
def main():
    ...
    # Data paths
    image_dir = r'PATH_TO_DIME_IMAGES'
    clinical_data_path =  r'PATH_TO_DIME_Clinical_data.xlsx'
